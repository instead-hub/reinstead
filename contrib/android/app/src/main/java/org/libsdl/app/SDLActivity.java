...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        outAttrs.inputType = InputType.TYPE_CLASS_TEXT; // reinstead | InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD;
        outAttrs.imeOptions = EditorInfo.IME_FLAG_NO_EXTRACT_UI
                | EditorInfo.IME_FLAG_NO_FULLSCREEN /* API 11 */ | EditorInfo.IME_ACTION_SEND; // reinstead
...
//    	}
    ...
    public boolean deleteSurroundingText(int beforeLength, int afterLength) {
        ...
        if (beforeLength > 0 && afterLength == 0 && false) { // reinstead
            boolean ret = true;
            // backspace(s)
