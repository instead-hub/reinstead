...
public static String copyDirorfileFromAssetManager(AssetManager asset_manager, String arg_assetDir, String arg_destinationDir) throws IOException
{
    ...
    for (int i = 0; i < files.length; i++)
    {
        ...
        } else
        {
            ...
            copyDirorfileFromAssetManager(asset_manager, abs_asset_file_path, addTrailingSlash(arg_destinationDir) + files[i]);
        }
    }
